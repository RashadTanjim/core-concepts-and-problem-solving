...
//    }
//
////  9. Monotonic increasing stack (The same logic can be applied to maintain a monotonic queue.)
//
//    public int fn(int[] arr) {
...
//    }
//
//    // 13. Graph: DFS (recursive) For the graph templates, assume the nodes are numbered from 0 to n - 1 and the graph is given as an adjacency list.

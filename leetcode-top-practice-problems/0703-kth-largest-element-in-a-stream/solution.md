# 703. Kth Largest Element in a Stream - Interview Solution

[Problem description](./README.md) | [Go implementation](./solution.go) | [Java implementation](./Solution.java) | [LeetCode](https://leetcode.com/problems/kth-largest-element-in-a-stream/)

## Pattern recognition

The main signal is **Priority Queue (Min Heap)**. Before coding, state what information the algorithm must remember and why that removes repeated work from the direct approach.
...
2. Represent that state with the data structure implied by **Priority Queue (Min Heap)**.

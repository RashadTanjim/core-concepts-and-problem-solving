# 121. Best Time to Buy and Sell Stock - Interview Solution

[Problem description](./README.md) | [Go implementation](./solution.go) | [Java implementation](./Solution.java) | [LeetCode](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/)

## Pattern recognition

The main signal is **Enumerate + Maintain the Minimum Value of the Prefix**. Before coding, state what information the algorithm must remember and why that removes repeated work from the direct approach.
...
2. Represent that state with the data structure implied by **Enumerate + Maintain the Minimum Value of the Prefix**.

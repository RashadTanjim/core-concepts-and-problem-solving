# 1235. Maximum Profit in Job Scheduling - Interview Solution

[Problem description](./README.md) | [Go implementation](./solution.go) | [Java implementation](./Solution.java) | [LeetCode](https://leetcode.com/problems/maximum-profit-in-job-scheduling/)

## Pattern recognition

The main signal is **Memoization Search + Binary Search**. Before coding, state what information the algorithm must remember and why that removes repeated work from the direct approach.
...
2. Represent that state with the data structure implied by **Memoization Search + Binary Search**.

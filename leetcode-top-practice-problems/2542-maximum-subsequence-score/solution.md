# 2542. Maximum Subsequence Score - Interview Solution

[Problem description](./README.md) | [Go implementation](./solution.go) | [Java implementation](./Solution.java) | [LeetCode](https://leetcode.com/problems/maximum-subsequence-score/)

## Pattern recognition

The main signal is **Sorting + Priority Queue (Min Heap)**. Before coding, state what information the algorithm must remember and why that removes repeated work from the direct approach.
...
2. Represent that state with the data structure implied by **Sorting + Priority Queue (Min Heap)**.

# 1520. Maximum Number of Non-Overlapping Substrings - Interview Solution

[Problem description](./README.md) | [Go implementation](./solution.go) | [Java implementation](./Solution.java) | [LeetCode](https://leetcode.com/problems/maximum-number-of-non-overlapping-substrings/)

## Pattern recognition

The main signal is **Greedy Interval Expansion**. Before coding, state what information the algorithm must remember and why that removes repeated work from the direct approach.
...
2. Represent that state with the data structure implied by **Greedy Interval Expansion**.

...
|---|---|---|
| Hard | Free | Hash Table, String, Greedy, Sorting |

[Open the complete problem on LeetCode](https://leetcode.com/problems/maximum-number-of-non-overlapping-substrings/)

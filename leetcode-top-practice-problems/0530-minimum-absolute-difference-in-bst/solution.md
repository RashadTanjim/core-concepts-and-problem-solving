# 530. Minimum Absolute Difference in BST - Interview Solution

[Problem description](./README.md) | [Go implementation](./solution.go) | [Java implementation](./Solution.java) | [LeetCode](https://leetcode.com/problems/minimum-absolute-difference-in-bst/)

## Pattern recognition

The main signal is **Inorder Traversal**. Before coding, state what information the algorithm must remember and why that removes repeated work from the direct approach.
...
2. Represent that state with the data structure implied by **Inorder Traversal**.

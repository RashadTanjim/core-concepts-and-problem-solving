# 13. Roman to Integer - Interview Solution

[Problem description](./README.md) | [Go implementation](./solution.go) | [Java implementation](./Solution.java) | [LeetCode](https://leetcode.com/problems/roman-to-integer/)

## Pattern recognition

The main signal is **Hash Table + Simulation**. Before coding, state what information the algorithm must remember and why that removes repeated work from the direct approach.
...
2. Represent that state with the data structure implied by **Hash Table + Simulation**.

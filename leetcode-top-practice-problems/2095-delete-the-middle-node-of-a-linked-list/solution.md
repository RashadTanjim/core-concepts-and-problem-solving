# 2095. Delete the Middle Node of a Linked List - Interview Solution

[Problem description](./README.md) | [Go implementation](./solution.go) | [Java implementation](./Solution.java) | [LeetCode](https://leetcode.com/problems/delete-the-middle-node-of-a-linked-list/)

## Pattern recognition

The main signal is **Fast and Slow Pointers**. Before coding, state what information the algorithm must remember and why that removes repeated work from the direct approach.
...
2. Represent that state with the data structure implied by **Fast and Slow Pointers**.

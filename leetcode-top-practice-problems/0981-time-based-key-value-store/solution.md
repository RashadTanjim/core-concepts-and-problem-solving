# 981. Time Based Key-Value Store - Interview Solution

[Problem description](./README.md) | [Go implementation](./solution.go) | [Java implementation](./Solution.java) | [LeetCode](https://leetcode.com/problems/time-based-key-value-store/)

## Pattern recognition

The main signal is **Hash Table + Ordered Set (or Binary Search)**. Before coding, state what information the algorithm must remember and why that removes repeated work from the direct approach.
...
2. Represent that state with the data structure implied by **Hash Table + Ordered Set (or Binary Search)**.

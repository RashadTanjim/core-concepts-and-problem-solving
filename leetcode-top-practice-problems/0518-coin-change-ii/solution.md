# 518. Coin Change II - Interview Solution

[Problem description](./README.md) | [Go implementation](./solution.go) | [Java implementation](./Solution.java) | [LeetCode](https://leetcode.com/problems/coin-change-ii/)

## Pattern recognition

The main signal is **Dynamic Programming (Complete Knapsack)**. Before coding, state what information the algorithm must remember and why that removes repeated work from the direct approach.
...
2. Represent that state with the data structure implied by **Dynamic Programming (Complete Knapsack)**.

# 332. Reconstruct Itinerary - Interview Solution

[Problem description](./README.md) | [Go implementation](./solution.go) | [Java implementation](./Solution.java) | [LeetCode](https://leetcode.com/problems/reconstruct-itinerary/)

## Pattern recognition

The main signal is **Eulerian Path**. Before coding, state what information the algorithm must remember and why that removes repeated work from the direct approach.
...
2. Represent that state with the data structure implied by **Eulerian Path**.

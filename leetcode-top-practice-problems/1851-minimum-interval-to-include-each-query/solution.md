# 1851. Minimum Interval to Include Each Query - Interview Solution

[Problem description](./README.md) | [Go implementation](./solution.go) | [Java implementation](./Solution.java) | [LeetCode](https://leetcode.com/problems/minimum-interval-to-include-each-query/)

## Pattern recognition

The main signal is **Sorting + Offline Query + Priority Queue (Min Heap)**. Before coding, state what information the algorithm must remember and why that removes repeated work from the direct approach.
...
2. Represent that state with the data structure implied by **Sorting + Offline Query + Priority Queue (Min Heap)**.

...
|---|---|---|
| Medium | Free | Array, Hash Table, Bit Manipulation, Trie |

[Open the complete problem on LeetCode](https://leetcode.com/problems/maximum-xor-of-two-numbers-in-an-array/)

# 114. Flatten Binary Tree to Linked List - Interview Solution

[Problem description](./README.md) | [Go implementation](./solution.go) | [Java implementation](./Solution.java) | [LeetCode](https://leetcode.com/problems/flatten-binary-tree-to-linked-list/)

## Pattern recognition

The main signal is **Find Predecessor Node**. Before coding, state what information the algorithm must remember and why that removes repeated work from the direct approach.
...
2. Represent that state with the data structure implied by **Find Predecessor Node**.

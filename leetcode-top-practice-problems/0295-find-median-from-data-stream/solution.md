# 295. Find Median from Data Stream - Interview Solution

[Problem description](./README.md) | [Go implementation](./solution.go) | [Java implementation](./Solution.java) | [LeetCode](https://leetcode.com/problems/find-median-from-data-stream/)

## Pattern recognition

The main signal is **Min Heap and Max Heap (Priority Queue)**. Before coding, state what information the algorithm must remember and why that removes repeated work from the direct approach.
...
2. Represent that state with the data structure implied by **Min Heap and Max Heap (Priority Queue)**.

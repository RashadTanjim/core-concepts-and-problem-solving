# 2390. Removing Stars From a String - Interview Solution

[Problem description](./README.md) | [Go implementation](./solution.go) | [Java implementation](./Solution.java) | [LeetCode](https://leetcode.com/problems/removing-stars-from-a-string/)

## Pattern recognition

The main signal is **Stack Simulation**. Before coding, state what information the algorithm must remember and why that removes repeated work from the direct approach.
...
2. Represent that state with the data structure implied by **Stack Simulation**.
